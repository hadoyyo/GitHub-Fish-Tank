  ...
  `;
    ...
    if (showLegend) {
      ...
      <g transform="translate(10, ${20 + index * 22})">
        <circle cx="7" cy="7" r="7" fill="${color}" stroke="#000" stroke-width="0.5" />
        <text x="20" y="11" font-size="11" fill="#ffffff" font-family="monospace">${displayName}: ${percentage.toFixed(1)}%</text>
      </g>
    `);
    }
  });
  ...
  if (showPlants) {
    ...
    decorations += `
      ...
      <g transform="translate(550, ${height-42})">
        <ellipse cx="-5" cy="22" rx="22" ry="4" fill="#000" opacity=".12"/>
        <line x1="0" y1="20" x2="0" y2="5" stroke="#2d6a1a" stroke-width="2.5"/>
        <line x1="0" y1="14" x2="-12" y2="4" stroke="#2d6a1a" stroke-width="2"/>
        <line x1="0" y1="14" x2="12" y2="4" stroke="#2d6a1a" stroke-width="2"/>
        <line x1="0" y1="10" x2="-7" y2="-2" stroke="#2d6a1a" stroke-width="1.8"/>
        <line x1="0" y1="10" x2="8" y2="-2" stroke="#2d6a1a" stroke-width="1.8"/>
        <line x1="-12" y1="4" x2="-18" y2="-4" stroke="#2d6a1a" stroke-width="1.5"/>
        <line x1="-12" y1="4" x2="-7" y2="-5" stroke="#2d6a1a" stroke-width="1.5"/>
        <line x1="12" y1="4" x2="18" y2="-4" stroke="#2d6a1a" stroke-width="1.5"/>
        <line x1="12" y1="4" x2="7" y2="-5" stroke="#2d6a1a" stroke-width="1.5"/>
        <ellipse cx="0" cy="3" rx="7" ry="5" fill="#3a8c22" opacity="0.9">
          <animate attributeName="rx" values="7;8;7" dur="3s" repeatCount="indefinite"/>
        </ellipse>
        <ellipse cx="-13" cy="1" rx="6" ry="4.5" fill="#4aa030" opacity="0.9">
          <animate attributeName="rx" values="6;7;6" dur="3.3s" repeatCount="indefinite"/>
        </ellipse>
        <ellipse cx="13" cy="1" rx="6" ry="4.5" fill="#3a8c22" opacity="0.9">
          <animate attributeName="rx" values="6;7;6" dur="2.8s" repeatCount="indefinite"/>
        </ellipse>
        <ellipse cx="-19" cy="-6" rx="5" ry="4" fill="#4aa030" opacity="0.85">
          <animate attributeName="rx" values="5;6;5" dur="3.5s" repeatCount="indefinite"/>
        </ellipse>
        <ellipse cx="19" cy="-6" rx="5" ry="4" fill="#3a8c22" opacity="0.85">
          <animate attributeName="rx" values="5;6;5" dur="3.1s" repeatCount="indefinite"/>
        </ellipse>
        <ellipse cx="-7" cy="-5" rx="5.5" ry="4" fill="#55b535" opacity="0.85">
          <animate attributeName="rx" values="5.5;6.5;5.5" dur="2.9s" repeatCount="indefinite"/>
        </ellipse>
        <ellipse cx="8" cy="-5" rx="5.5" ry="4" fill="#4aa030" opacity="0.85">
          <animate attributeName="rx" values="5.5;6.5;5.5" dur="3.4s" repeatCount="indefinite"/>
        </ellipse>
      </g>
    `;
  }
    ...
    <svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
      ...
      ${showLegend ? `
        <g transform="translate(${width - 150}, 0)">
          <rect x="0" y="10" width="140" height="${legendItems.length * 22 + 10}" fill="rgba(0, 0, 0, 0.2)" rx="6" />
