const FISH_SHAPES = {
  ...
  default: (color) => `
    <g>
      ...
      <path d="M -17.621 -5.495 L -12.621 3.505 L -12.621 -12.495 L -17.621 -5.495 Z" fill="${color}" style="stroke-width: 1; transform-origin: -15.121px -4.495px;" transform="matrix(-1, 0, 0, -1, -0.00000572, -0.00000286)"/>
  ...
  tetra: (color) => `
    <g>
      ...
      <path d="m-7.598-2.721-10.879-6.103 2.879 12.103z" fill="${color}" style="stroke-width:1"/>
  ...
  csharp: (color) => `
    <g>
      ...
      <path d="m-6.973.108-9-6v12z" fill="${color}" style="stroke-width:1"/>
  ...
  jupyter: (color) => `
    ...
    svelte: (color) => `
    <g>
      <path d="M14.457.916.419-7.858V9.689z" fill="#fff" style="stroke-width:1"/>
      <path d="M20.388.945 6.35-7.829V9.718z" fill="#fff" style="stroke-width:1"/>
      <path d="m-13.736-4.248-14.037-8.773V4.526zM6.487-9.959l-14.036-8.773v17.547z" fill="${color}" style="stroke-width:1"/>
      <rect x="-12.439" y="-14.7" width="37.121" height="20.669" fill="${color}" rx="10.335" ry="10.335"/>
      <path style="fill:none;stroke:#fff;stroke-width:5px;transform-origin:-3.338px -4.134px" d="m-21.494-4.153 21.561.022 14.752.015"/>
      <circle cx="14.69" cy="-4.12" r="3.372" fill="#000" style="stroke-width:1"/>
      <circle cx="15.625" cy="-5.057" r="1.312" fill="#fff" style="stroke-width:1"/>
    </g>
    `,
    solidity: (color) => `
    <g>
      <path d="M15.296-6.965 8.797-24.129l-20.108-1.45 7.895 17.924-8.129 17.93L8.001 8.474z" fill="${color}" style="stroke-width:1;transform-origin:7.448px -10.796px"/>
      <circle cx="8.829" cy="-9.587" r="2.446" fill="#000" style="stroke-width:1"/>
      <circle cx="9.508" cy="-10.266" r=".951" fill="#fff" style="stroke-width:1"/>
      <path d="m-2.965-7.281-2.812-7.427-8.702-.628 3.418 7.757L-14.58.179-6.122-.6z" fill="${color}" style="stroke-width:1;transform-origin:-5.941px -10.881px"/>
    </g>
    `,
    zig: (color) => `
    <g>
      <path style="fill:#728942" d="M-35.611-4.333h30.978v-8.3c2.209-1.841-26.273 4.378-30.978 8.3"/>
      <path style="fill:#728942;stroke-width:1;transform-box:fill-box;transform-origin:50% 50%" d="M12.688-10.78c.696-1.949 5.21-3.017 10.809-2.83 6.173.206 8.052 1.068 7.691 2.076v6.398c.329.782-5.083 3.96-9.414.994-5.086-3.483-7.109-5.437-9.086-6.638" transform="scale(-1)"/>
      <rect x="-14.252" y="-16.256" width="29.346" height="15.694" rx="7.943" ry="7.943" fill="${color}"/>
      <rect x="3.139" y="8.608" width="16.838" height="5.684" rx="2.72" ry="2.72" fill="${color}" style="stroke-width:1;transform-box:fill-box;transform-origin:50% 50%" transform="rotate(137.21 -6.469 -11.637)"/>
      <rect x="3.139" y="8.608" width="16.838" height="5.684" rx="2.72" ry="2.72" fill="${color}" style="stroke-width:1;transform-origin:11.558px 11.45px" transform="rotate(137.21 -.446 -7.798)"/>
      <path style="fill:#728942;stroke-width:1;transform-origin:-24.106px -10.009px" d="M-25.11-11.15c-.449.15-.07 3.82.196 3.731l3.128-1.365c.812-.033-1.595-2.436-3.324-2.366"/>
      <path style="fill:#728942;stroke-width:1;transform-origin:-17.902px -11.046px" d="M-19.276-12.607c-.613.205-.096 5.229.269 5.106l4.284-1.867c1.111-.046-2.186-3.336-4.553-3.239"/>
      <path style="fill:#728942;stroke-width:1;transform-origin:-29.347px -8.244px" d="M-30.351-9.386c-.448.151-.07 3.821.197 3.732l3.128-1.365c.812-.033-1.595-2.437-3.325-2.367"/>
      <rect x=".707" y="8.608" width="3.795" height="5.684" rx="2.72" ry="2.72" fill="#ff0" style="stroke-width:1;transform-origin:2.605px 11.45px" transform="rotate(137.21 -5.28 -8.57)"/>
      <rect x=".707" y="8.608" width="3.795" height="5.684" rx="2.72" ry="2.72" fill="#ff0" style="stroke-width:1;transform-origin:2.605px 11.45px" transform="rotate(137.21 .56 -4.634)"/>
      <circle cx="20.632" cy="-9.866" r="1.317" fill="#fff" style="stroke-width:1"/>
      <circle cx="29.964" cy="-9.81" r=".798" fill="#000" style="stroke-width:1" transform="matrix(.54591 .78095 -.35326 1.2534 .876 -21.016)"/>
      <circle cx="22.357" cy="-7.983" r="10.798" fill="#add8e6" style="stroke-width:1" opacity=".5"/>
    </g>
    `,
    fortran: (color) => `
    <g>
      <circle cx="20.134" cy="-8.377" r="1.8" fill="#000" style="stroke-width:1"/>
      <circle cx="20.634" cy="-8.877" r=".7" fill="#fff" style="stroke-width:1"/>
      <ellipse cx="3.435" cy="-4.505" rx="22.651" ry="7" fill="${color}" style="stroke-width:1"/>
      <path d="m-13.458-2.899.269-2.978-10.376-4.628v12z" fill="${color}" style="stroke-width:1"/>
      <circle cx="18.753" cy="-8.382" r="1.8" fill="#000" style="stroke-width:1"/>
      <circle cx="19.253" cy="-8.882" r=".7" fill="#fff" style="stroke-width:1"/>
      <path d="m-3.878 1.844.269-1.873-10.376-2.909v7.544z" fill="${color}" style="stroke-width:1"/>
      <path style="fill:none;stroke:#000" d="M25.986-4.504c-5.273.077-3.724 8.246-8.282 7.041"/>
      <path d="m-6.187-8.247.274 1.873-10.557 2.909v-7.544z" fill="${color}" style="stroke-width:1"/>
      <path style="fill:none;stroke:#000;opacity:.3" d="M11.12-7.209s-1.253 2.03-1.278 3.348c-.026 1.357 1.203 3.614 1.203 3.614"/>
    </g>
    `
};
